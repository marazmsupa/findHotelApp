...
<head>
  ...
  <title>FindHotel - поиск страны</title>
</head>
<body>
      ...
      <div class="container">
        <div class="index_hotels_section_inner">
          <div class="index_hotels_section_header">
            <div>
              <h2>Результаты</h2>
              <p class="search_results_count">Всего найдено по фильтрам ${countriesListCount} стран</p>
            </div>
            <div>
              <g:link controller="countries" action="list">Управление странами</g:link>
            </div>
          </div>
